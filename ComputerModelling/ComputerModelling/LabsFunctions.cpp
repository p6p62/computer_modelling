...
void lab2_program()
{
	...
	constexpr int INTERVALS_COUNT{ 20 };
	...
	const double pearson_value{ MathFunctions::pearson_criteria(random_data, intervals,
		[](double x) -> double {return MathFunctions::uniform_distribution_function(x); }) };
